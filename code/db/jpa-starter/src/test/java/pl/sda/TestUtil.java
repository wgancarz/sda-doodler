...
public class TestUtil {
    public static void setUpDatabase(JdbcConnectionManager jdbcConnectionManager, String sql) throws SQLException {
        executeOnDatabase(jdbcConnectionManager, sql);
    }
